...
namespace Basics_Final_Project_InformationEncoding.CustomPolicyProvider
{
    ...
    public static class DynamicAuthorizationPolicyFactory
    {
        public static AuthorizationPolicy Create(string policyName)
        {
            ...
            switch (type)
            {
                case DynamicPolicies.Rank: // user needs to be this rank
                    return new AuthorizationPolicyBuilder()
                        .RequireClaim("Rank", value)
                        .Build();
                case DynamicPolicies.SecurityLevel: // user needs to have either this security level or higher or something specific
                    return new AuthorizationPolicyBuilder()
